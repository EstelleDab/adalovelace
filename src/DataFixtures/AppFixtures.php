...
class AppFixtures extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        $article->setContent("La force tranquille de l'equipe... Pleine de contradictions, elle est en t shirt quand on sort les mouffles... bon aprés pas sûrs qu en Afrique du Sud ils connaissent les moufles?? En tous cas elle sait garder la tete froide et calmer les deux autres agités du bocal quand il faut");
        $article->setCategory($categorie2);
        $manager->persist($article);
        $manager->flush();
